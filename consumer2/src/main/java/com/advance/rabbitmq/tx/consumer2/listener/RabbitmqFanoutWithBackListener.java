...
import com.advance.rabbitmq.tx.consumer2.config.RabbitmqConfig;
...
@Component
@Slf4j
public class RabbitmqFanoutWithBackListener {
    ...
    @RabbitHandler
    @RabbitListener(queues = RabbitmqConfig.DEMO_FANOUT_QUEUE)
